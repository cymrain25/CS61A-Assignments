class Transaction:
    ...
    def report(self):
        ...
        """
        msg = 'no change'
        x, y = self.before, self.after
        if self.changed():
            if x > y:
                msg = 'decreased ' + str(x) + '->' + str(y)
            else:
                msg = 'increased ' + str(x) + '->' + str(y)
...
class BankAccount:
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(x, self.balance, self.balance))
            return 'Insufficient funds'
        self.transactions.append(Transaction(x, self.balance, self.balance - amount))
        self.balance = self.balance - amount
        return self.balance
...
class Coin:
    ...
    def worth(self):
        x = max(Mint.present_year - self.year - 50, 0)
        return x + self.cents
